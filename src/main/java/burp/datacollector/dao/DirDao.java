...
public class DirDao extends BaseDao {
    ...
    public void importDirFromFile(String fileName) throws IOException, SQLException, CsvValidationException {
        ...
        StringBuilder sqlStringBuilder = new StringBuilder("INSERT INTO `dir` (`dir`, `count`) VALUES");
        int n = lineLength - 1;
        for (int i = 0; i < n - 1; i++) {
