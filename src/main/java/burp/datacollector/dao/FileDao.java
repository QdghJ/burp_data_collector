...
public class FileDao extends BaseDao {
    ...
    public void importFileFromFile(String fileName) throws IOException, SQLException, CsvValidationException {
        ...
        StringBuilder sqlStringBuilder = new StringBuilder("INSERT INTO `file` (`filename`, `count`) VALUES");
        int n = lineLength - 1;
        for (int i = 0; i < n - 1; i++) {
